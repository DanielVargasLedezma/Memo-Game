...
${OBJECTDIR}/source_files/Casilla.o: source_files/Casilla.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_files/Casilla.o source_files/Casilla.c

${OBJECTDIR}/source_files/Game.o: source_files/Game.c
	${MKDIR} -p ${OBJECTDIR}/source_files
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_files/Game.o source_files/Game.c

${OBJECTDIR}/source_files/Tablero.o: source_files/Tablero.c
	${MKDIR} -p ${OBJECTDIR}/source_files
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_files/Tablero.o source_files/Tablero.c

${OBJECTDIR}/source_files/main.o: source_files/main.c
	${MKDIR} -p ${OBJECTDIR}/source_files
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source_files/main.o source_files/main.c
